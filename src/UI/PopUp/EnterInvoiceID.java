 ...
 * @author RH Rafi
 */
public class EnterInvoiceID extends javax.swing.JFrame {

    /**
     * Creates new form NoConnection
     */
    public EnterInvoiceID() {
        initComponents();
        setIcon();
//        setData();
    }
    ...
    private void initComponents() {
        ...
        lblNoConnection1.setText("Enter Invoice ID and press Enter");
        getContentPane().add(lblNoConnection1, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 90, 280, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EnterInvoiceID.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EnterInvoiceID().setVisible(true);
            }
        });
    }
