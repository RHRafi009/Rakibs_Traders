 ...
 * @author RH Rafi
 */
public class DeleteEmployeePayment extends javax.swing.JFrame {

    /**
     * Creates new form Delete
     */
    public DeleteEmployeePayment() {
        initComponents();
        setIcon();
        isOkPressed = false;
        PlaceHolder place = new PlaceHolder(txtFieldExpenseID,"Enter Reciept No.");
    ...
    private void initComponents() {
        ...
        lblPaidRecieptNumVal = new javax.swing.JLabel();
        ...
        txtFieldExpenseID = new javax.swing.JTextField();
        userPassF = new javax.swing.JPasswordField();
        jLabelWrong = new javax.swing.JLabel();
        jButton1 = new javax.swing.JButton();
        lblPaidAmountValue1 = new javax.swing.JLabel();
        ...
        lblInvoiceID2.setText("Expense ID:");
        getContentPane().add(lblInvoiceID2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 20, 170, -1));

        lblPaidRecieptNumVal.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblPaidRecieptNumVal.setForeground(new java.awt.Color(255, 255, 255));
        lblPaidRecieptNumVal.setText("#Rec. No");
        getContentPane().add(lblPaidRecieptNumVal, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 60, 103, 23));
        ...
        getContentPane().add(txtFieldExpenseID, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 20, 200, 30));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 20, -1, 30));

        lblPaidAmountValue1.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        lblPaidAmountValue1.setForeground(new java.awt.Color(255, 255, 255));
        lblPaidAmountValue1.setText("#Paid Amount");
        getContentPane().add(lblPaidAmountValue1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 90, 103, 23));
    ...
    public void setTheValue(){
          ...
          String query2 = "select * from employee_salary where exp_ID = ?";

         if( txtFieldExpenseID.getText().startsWith("EXP#")) {
             isOkPressed = true;
             PreparedStatement pstmt;
            try {
                pstmt = con.prepareStatement(query2);
                pstmt.setString(1,txtFieldExpenseID.getText());
                ResultSet rs = pstmt.executeQuery();

                while( rs.next() ){
                    lblPaidRecieptNumVal.setText(rs.getInt("reciept_ID") + "");
                    lblPaidAmountValue1.setText(String.format("%.4f",rs.getDouble("amount")));
                    employeeID = rs.getString("emp_ID");
                }

            } catch (SQLException ex) {
                Logger.getLogger(DeleteEmployeePayment.class.getName()).log(Level.SEVERE, null, ex);
            }
         }
    }
    ...
    private void jButtonAddPaymentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonAddPaymentActionPerformed
        ...
        if( checkPassword() && isOkPressed ){ 
               String query = "DELETE FROM expenses where exp_ID = ?";
               String query2 = "DELETE FROM employee_salary where exp_ID = ?";
               Connection con = DBConnectionProvider.getDBConnection();
                ...
                try{
                    ...
                    page.setMessage("Expense And Employee Salary");
...
//        btnGoActionPerformed(evt);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeleteEmployeePayment.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeleteEmployeePayment().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JLabel lblPaidAmountValue1;
    private javax.swing.JLabel lblPaidRecieptNumVal;
    private javax.swing.JLabel lblTimeanddate4;
    private javax.swing.JLabel lblTimeanddate5;
    private javax.swing.JTextField txtFieldExpenseID;
...
//        this.lblInvoiceIDValue1.setText(invoiceID);
        this.lblPaidRecieptNumVal.setText(paidAmount);
        this.flag = flag;
