 ...
 * @author RH Rafi
 */
public class PutIDFirst extends javax.swing.JFrame {
...
//        setData();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PutIDFirst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PutIDFirst().setVisible(true);
            }
        });
    }
