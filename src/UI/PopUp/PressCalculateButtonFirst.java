 ...
 * @author RH Rafi
 */
public class PressCalculateButtonFirst extends javax.swing.JFrame {

    /**
     * Creates new form NoConnection
     */
    public PressCalculateButtonFirst() {
        initComponents();
        setIcon();
//        setData();
    }
    ...
    private void initComponents() {
        ...
        lblNoConnection1.setText("Press calculate button first.");
        getContentPane().add(lblNoConnection1, new org.netbeans.lib.awtextra.AbsoluteConstraints(150, 90, 210, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PressCalculateButtonFirst.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PressCalculateButtonFirst().setVisible(true);
            }
        });
    }
