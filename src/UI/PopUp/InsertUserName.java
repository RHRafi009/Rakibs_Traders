 ...
 * @author RH Rafi
 */
public class InsertUserName extends javax.swing.JFrame {
...
//        setData();
    ...
    private void initComponents() {
        ...
        lblNoConnection1.setText("Insert a valid User name First");
        getContentPane().add(lblNoConnection1, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 90, 280, 20));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertUserName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertUserName().setVisible(true);
            }
        });
    }
