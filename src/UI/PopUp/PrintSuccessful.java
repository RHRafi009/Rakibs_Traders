 ...
 * @author RH Rafi
 */
public class PrintSuccessful extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setMinimumSize(new java.awt.Dimension(531, 235));
        ...
        lblNoConnection.setText("PRINT IS SUCCESSFUL");
        ...
        jLabelBackground.setMaximumSize(new java.awt.Dimension(530, 235));
        jLabelBackground.setMinimumSize(new java.awt.Dimension(530, 230));
        jLabelBackground.setPreferredSize(new java.awt.Dimension(530, 230));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrintSuccessful.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrintSuccessful().setVisible(true);
            }
        });
    }
