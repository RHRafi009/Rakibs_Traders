...
public class ProfitReport extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("32 days");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 430, 200, 40));
        ...
        jTextFieldEndingDate.setText("Ending Date");
        jTextFieldEndingDate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldEndingDateActionPerformed(evt);
            }
        });
        getContentPane().add(jTextFieldEndingDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(550, 80, 180, 30));

        jTextFieldStartingDate.setText("Starting Date");
        jTextFieldStartingDate.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldStartingDateActionPerformed(evt);
            }
        });
        getContentPane().add(jTextFieldStartingDate, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 80, 180, 30));

        jLabel2.setBackground(new java.awt.Color(204, 204, 204));
        jLabel2.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(204, 204, 204));
        jLabel2.setText("Buy Reports by:");
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 150, 40));
   ...
   // */
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfitReport.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
